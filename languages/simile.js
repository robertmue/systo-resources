...
NodeType: {
   ...
   cloud: {
      ...
      width: 35,
      height: 20,
      border_colour: {set:   {normal:'#e8e8e8',   selected:'blue',    highlight:'green'},
                      unset: {normal:'#e8e8e8',   selected:'blue',    highlight:'green'}},
   ...
   variable: {
      ...
      border_colour: {set:   {normal:'white',   selected:'blue',    highlight:'green'},
                      unset: {normal:'#ffe0e0',     selected:'blue',    highlight:'green'}},
      fill_colour:   {set:   {normal:'white', selected:'white', highlight:'#e0e0e0'},
   ...
   valve: {
      ...
      line_width:    {set:   {normal:1.5,       selected:5,         highlight:5},
                      unset: {normal:1.5,       selected:5,         highlight:5}},
...
ArcType:{
   flow: {
      ...
      arrowhead:{shape:'diamond', gap:6, width:5, front:12, back:0},
...
*/
   ...
   influence: {
      ...
      line_width: {set:   {normal:1,   selected:2,    highlight:2},
                      unset: {normal:1,     selected:2,    highlight:2}},
...
ContainerType: {
   submodel: {
      counter: 0,
      has_button: true,
      button_label: 'Submodel',
      button_icon:'data:image/gif;base64,R0lGODlhEAAPAIABAAAAAP///yH5BAEKAAEALAAAAAAQAA8AAAIcjI+py50Ao4QHOGPtxXrTHXxed4ll6FXTCrZLAQA7',
      has_label: true,
      default_label_root: 'submodel',
      shape: 'rectangle',
      border_colour: {set:   {normal:'black',   selected:'blue',    highlight:'green'},
                      unset: {normal:'red',     selected:'blue',    highlight:'green'}},
      fill_colour:   {set:   {normal:'yellow', selected:'green', highlight:'blue'},
                      unset: {normal:'red', selected:'orange', highlight:'purple'}},
      line_width:    {set:   {normal:1,         selected:2,         highlight:2},
