SYSTO.languages.system_dynamics_im = {
...
NodeType: {
   stock: {
      ...
      fill_colour:   {set:   {normal:'#a6d3f8', selected:'#e0e0e0', highlight:'#e0e0e0'},
                      unset: {normal:'#e0e0e0', selected:'#e0e0e0', highlight:'#e0e0e0'}},
   ...
   variable: {
      ...
      fill_colour:   {set:   {normal:'#fdcdac',   selected:'white',   highlight:'white'},
                      unset: {normal:'#fdcdac',   selected:'white',   highlight:'white'}},
      line_width:    {set:   {normal:2,         selected:2,         highlight:2},
                      unset: {normal:1.5,       selected:2,         highlight:2}},
      display_colour: 'black',
      text_shiftx: 0,
   ...
   converter: {
      ...
      border_colour: {set:   {normal:'black',   selected:'blue',    highlight:'green'},
                      unset: {normal:'red',     selected:'blue',    highlight:'green'}},
      fill_colour:   {set:   {normal:'#b3e2cd',   selected:'white',   highlight:'white'},
...
ArcType:{
   flow: {
      ...
      default_label_root: 'flow',
      shape: 'straight',
      line_colour: {set:   {normal:'#6482b9',   selected:'blue',    highlight:'green'},
                      unset: {normal:'red',     selected:'blue',    highlight:'green'}},
      fill_colour: {set:   {normal:'#6482b9',   selected:'blue',    highlight:'green'},
                      unset: {normal:'red',     selected:'blue',    highlight:'green'}},
      line_width:    {set:   {normal:4,         selected:4,         highlight:4},
                      unset: {normal:4,       selected:4,         highlight:4}},
      arrowhead:{shape:'diamond', gap:6, width:4, front:9, back:-3},
   ...
   influence: {
      ...
      line_colour: {set:   {normal:'#b0b0b0',   selected:'blue',    highlight:'green'},
                      unset: {normal:'red',     selected:'blue',    highlight:'green'}},
      ...
      arrowhead:{shape:'diamond', gap:2, width:3, front:7, back:-2},
      internode_type: null,
