...
NodeType: {
   stock: {
      ...
      fill_colour:   {set:   {normal:'white', selected:'#e0e0e0', highlight:'#e0e0e0'},
   ...
   cloud: {
      ...
      fill_colour:   {set:   {normal:'black', selected:'#e8e8e8', highlight:'#e8e8e8'},
                      unset: {normal:'black', selected:'#e8e8e8', highlight:'#e8e8e8'}},
...
ArcType:{
   flow: {
      ...
      fill_colour: {set:   {normal:'black',   selected:'blue',    highlight:'green'},
                      unset: {normal:'red',     selected:'blue',    highlight:'green'}},
      line_width: {set:   {normal:6,   selected:4,    highlight:4},
                      unset: {normal:4,     selected:4,    highlight:4}},
      arrowhead:{shape:'diamond', gap:1, width:10, front:10, back:-6},
...
*/
   ...
   influence: {
      ...
      arrowhead:{shape:'diamond', gap:2, width:8, front:11, back:-7},
      internode_type: null,
