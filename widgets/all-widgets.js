   ...
   */
    $.widget('systo.compare_models_text', {
        ...
        _create: function () {
            ...
            console.debug('compare_models_text !!!!!!!!!!!!!!!');
   ...
   */
    $.widget('systo.multiple_sliders', {
        ...
        addNode: function (nodeId) {
            var model = SYSTO.models[this.options.modelId];
            var node = model.nodes[nodeId];
            var sliderElement = $('<div class="slider1" style="float:left; padding:7px; margin:1px; width:400px; height:16px;"></div>').slider1({modelId:this.options.modelId, label:node.label, value:node.value, minval:node.minval, maxval:node.maxval});
        ...
        _create: function () {
            ...
            $(document).on('change_model_listener', {}, function(event, parameters) {
                if (!parameters.packageId || parameters.packageId === self.options.packageId) {
                    ...
                    $(sliders_div).empty();
                    for (var nodeId in self.model.nodes) {
                        var node = self.model.nodes[nodeId];
...
//    we trigger a 'display_listener' click event,which causes the graphs to be re-drawn.
    ...
    $.widget('systo.multi_plotter', {
        ...
        options: {
            ...
            packageId: 'package1',
            selectNode: function (node) {
                if (SYSTO.results && SYSTO.results[node.id]) {
                    return true;
                } else {
                    return false;
                }
        ...
        _create: function () {
            ...
            $(document).on('display_listener', {}, function(event, parameters) {
                if (!parameters.packageId || self.options.packageId === parameters.packageId) {
                    if (self.options.active) {
                        if (SYSTO.results) {
                            self.model = SYSTO.models[SYSTO.state.currentModelId];
   ...
   */
    $.widget('systo.similive', {
        ...
        _create: function () {
            ...
            var dummy = $('<div class="similive_listener" style="display:none;" >Click me!</div>').
                click(function(event, oldModelId, newModelId) {
                    similive();
                });
            $(div).append(dummy);
...
function similive() {
    ...
    "nodes":{
            ...
            "valve1": {"id":"valve1", "type":"valve", "label":"births", "centrex":126, "centrey":240, "text_shiftx":-29, "text_shifty":-10, "extras":{"equation":{"type":"long_text", "default_value":"", "value":"birth_rate*Population*quality_of_environment*consumption_level*birth_control"}, "min_value":{"type":"short_text", "default_value":"", "value":"0"}, "max_value":{"type":"short_text", "default_value":"", "value":"23"}, "documentation":{"type":"long_text", "default_value":"", "value":""}, "comments":{"type":"long_text", "default_value":"", "value":""}}},
            "valve2": {"id":"valve2", "type":"valve", "label":"deaths", "centrex":283.5, "centrey":242, "text_shiftx":8, "text_shifty":-24, "extras":{"equation":{"type":"long_text", "default_value":"", "value":"death_rate*Population*Environ_pollution"}, "min_value":{"type":"short_text", "default_value":"", "value":""}, "max_value":{"type":"short_text", "default_value":"", "value":""}, "documentation":{"type":"long_text", "default_value":"", "value":""}, "comments":{"type":"long_text", "default_value":"", "value":""}}},
            ...
            "variable7": {"id":"variable7", "type":"variable", "label":"quality_of_environment", "centrex":318, "centrey":50, "text_shiftx":0, "text_shifty":0, "extras":{"equation":{"type":"long_text", "default_value":"", "value":"damage_threshold/Environ_pollution"}, "min_value":{"type":"short_text", "default_value":"", "value":""}, "max_value":{"type":"short_text", "default_value":"", "value":""}, "documentation":{"type":"long_text", "default_value":"", "value":""}, "comments":{"type":"long_text", "default_value":"", "value":""}}},
    ...
    //var model = SYSTO.prepareModelForSaving(SYSTO.models[SYSTO.state.currentModelId]);
    var model = prepareModelForSimilive(SYSTO.models[SYSTO.state.currentModelId]);
    //console.debug(JSON.stringify(mwStr,null,4));
    //console.debug(JSON.stringify(model,null,4));
    $.post(
        'http://similive.simileweb.com:/model_action.php', 
        //{"act":"ConvertJSON","js_mod":JSON.stringify(mwStr)},
        {"act":"ConvertJSON","js_mod":JSON.stringify(model)},
        function(base) {
            fileBase = base;
            $.post('http://similive.simileweb.com:/model_action.php', 
                {"act":"BuildShareLib","base":fileBase},
                function() {
                $.post('http://similive.simileweb.com:/model_action.php', 
                    {"act":"CreateSocket","base":fileBase},
            ...
            $.post('http://similive.simileweb.com:/model_action.php', {"act":"WaitSocket", "base":fileBase}, 
                function(port) {
                svrPort = port;
                alert("Got socket " + port);
                continueAction();
    ...
    function continueAction() {
        ...
        // First get the component names.
        $.post(
            'http://similive.simileweb.com:/model_action.php', 
            {"port" : svrPort, "act":"Describe"}, 
            function(data) {
                //d1.insertAdjacentHTML('beforeend', '<p>' + data);
            }
        );  // End of $.port()
            ...
            function() {
                $.post(
                    ...
                    function(data) {
                        ...
                        // Now run the model and get three compartment values at completion...
                        $.post(
                            'http://similive.simileweb.com:/model_action.php', 
                            {"port" : svrPort, "act":"Execute", 
                                "runlength":20, "current":0, "step":1, 
                                "log":1, "note":"node00026,node00028,node00030"
                            },
                            function(data) {
                                //d1.insertAdjacentHTML('beforeend', '<p>' + data);
                                console.debug(data);
                                ...
                                console.debug(SYSTO.results);
                                SYSTO.trigger1({
                                    triggering_file:'jquery.similive.js', 
                                    triggering_action:'similive results', 
                                    listener_class: 'display_listener', 
                                    event_type: 'click', 
                                    argument_array: [{modelId:'miniworld'}]});
                            }
                        );
                    }
                );
